            ...
            try {
                ...
                if (ShopUtil.ccShop.get().contains(shopName + "." + s + ".value")) {
                    ...
                    if (!tradeType.equalsIgnoreCase("SellOnly"))
                        lore.add(LangUtil.ccLang.get().getString("PRICE") + df.format(buyPrice) + " " + valueChangedRange);
                    if (!tradeType.equalsIgnoreCase("BuyOnly"))
                        lore.add(LangUtil.ccLang.get().getString("SELLPRICE") + df.format(sellPrice) + " " + valueChangedRange2);
                    /* */
